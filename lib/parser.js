...
var parser = {
    ...
    parseAhref: function (url, proxy, fn) {
        ...
        request.get({
            ...
            var match = body.match(/<tbody>([\s\S]*?)<\/tbody>/gmi);
            if (!match || !match[0])
                return fn(e);
            ...
            data.domain_authority = td.eq(7).text().replace(/[^\d]/g, '');
            data.backlinks_domains = td.eq(14).text().replace(/[^\d]/g, '');
            data.backlinks_gov_domain = td.eq(10).text().replace(/[^\d]/g, '');
            data.backlinks_edu_domain = td.eq(11).text().replace(/[^\d]/g, '');
            data.backlinks_ips = td.eq(12).text().replace(/[^\d]/g, '');
            data.backlinks_subnets = td.eq(13).text().replace(/[^\d]/g, '');
            data.backlinks_all = td.eq(15).text().replace(/[^\d]/g, '');
            data.backlinks_text = td.eq(16).text().replace(/[^\d]/g, '');
            data.backlinks_nofollow = td.eq(17).text().replace(/[^\d]/g, '');
            data.backlinks_redirect = td.eq(18).text().replace(/[^\d]/g, '');
            data.backlinks_images = td.eq(19).text().replace(/[^\d]/g, '');
            data.backlinks_gov_links = td.eq(22).text().replace(/[^\d]/g, '');
            data.backlinks_edu_links = td.eq(23).text().replace(/[^\d]/g, '');
